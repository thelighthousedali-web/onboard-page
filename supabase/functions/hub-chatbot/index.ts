...
- [정규직 전용] 사내 카페(틔움): 더헥토앱 헥토월렛(오하이월렛) 바코드로 헥토코인·헥토M코인 결제, Hecto 앱 '틔움'에서 메뉴 확인, 판매수익금은 기부 (2026-09-01부터 헥토코인 제도로 통합 — 기존 월 22,000P 자동충전·복지포인트 2만원 차감 방식은 폐지)
...
## 입사 첫날 안내 [공통 — 단, 헥토월렛/BPO카드는 정규직 전용]
필수 앱: The Hecto App(전화번호 인증, 안되면 장성욱 책임 문의), 네이버웍스(ID=아이디+@hecto.co.kr, PW=생년월일6자리, 로그인 안되면 김강현 책임 문의).
[정규직 전용] 더헥토앱에서 헥토월렛(오하이월렛) 가입 신청 + 내 통장 연결(승인까지 최대 3영업일) → 승인 후 BPO 카드 신청(배송 3~4영업일). 헥토코인은 걸음수 기반 자동충전(월 최대 20만보=20만코인)되어 사내카페(틔움)·BPO카드 결제·동료 선물에 사용.
